  ...
  <!-- 加上调用分享的弹出层 -->
   ...
   <div class="wan_img">
     ...
     <div class="agree ">
         ...
         <p style="text-align:left">当前著作权人<span>张某某</span></p>
            <div v-show="!isshow">
             <div style="font-size:1rem;text-align:center">变更信息</div>
             <p style="text-align:center">暂无变更信息</p>
             </div>
             <div v-show="isshow">
               <p style="font-size:14px;color:#ffffff">2018-09-21 &nbsp;19:20:20 &nbsp;李某某转让给张某某</p>
...
export default {
    ...
    mounted(){
      // 请求申请成功显示证书
        ...
        this.number = ' 22A60CC41878924AA027555230B3716D'
        let _p ={
          number
        }
